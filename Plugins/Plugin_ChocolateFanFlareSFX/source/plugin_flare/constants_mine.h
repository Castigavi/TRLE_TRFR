...
#define STANDARD_SOUND_INDEX_MAXIMUM 369
#define EXTENDED_SOUND_INDEX_MAXIMUM 231

#define FLARE_LIFETIME_ADDRESS 0x42F0AA
#define FLARE_IN_HAND_CURRENT_TIME_ADDRESS 0x80DEE6

#define MASK_WORD_MAGNITUDE 0x7FFF
#define MASK_WORD_SIGN 0x8000

#define SFX_LAND 0
#define SFX_UNDERWATER 1

#define TYPE_UNDERWATER 1
#define TYPE_FREE 2
#define TYPE_BURN 4

#define FLIPEFFECT_ASSIGN_FIRST 1
#define FLIPEFFECT_ASSIGN_SECOND 2
#define FLIPEFFECT_ASSIGN_THIRD 3
#define FLIPEFFECT_ASSIGN_NONE 4
#define FLIPEFFECT_ENABLE_BUBBLES 5
#define FLIPEFFECT_DISABLE_BUBBLES 6
#define FLIPEFFECT_ENABLE_SYNCHRONIZATION 7
#define FLIPEFFECT_DISABLE_SYNCHRONIZATION 8

#define PROBABILITY_HALF 16384

#define SIZE_MINIMUM 8
#define SIZE_VARIATION 7

#define DISPLACEMENT_FLARE_X 11
#define DISPLACEMENT_FLARE_Y 32
#define DISPLACEMENT_FLARE_Z 41

#define JOINT_LEFT_HAND 14

...
#READ BEFORE PLAYING:
######################################################################
Skeletons in the second level can be killed by just shooting them.
...
- TEETH SPIKES behave more like in classic games
- Delays between animations are fixed. Lara's movement is more similar to TR1-3
- Climbing into crawlspace works like in TR5, so you don't need to push crouch button anymore
- Lara can grab pickups while being in crouch mode
- Jumping out of crawlspace works everywhere now
- 180' turning on monkeybars works much better now
